...
def main(args):
    ...
    audiomnist_test = LibriSpeech4SpeakerRecognition(
        root="/data/speech", subset="test", project_fs=16000, wav_length=80000, url='train-clean-100'
    )
    ...
    for i in range(n_iter):
        ...
        power = (power.mean() / 1000).sqrt().item()
